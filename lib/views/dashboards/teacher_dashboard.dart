...
class TeacherDashboard extends StatelessWidget {
  ...
  final bool isEn;
  const TeacherDashboard({super.key, required this.user, required this.isDarkMode, required this.isEn});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.logout_rounded, color: _sub),
              onPressed: () async { await AuthService.logout(); if (context.mounted) Navigator.of(context).popUntil((r) => r.isFirst); }),
        ],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 5),
                  ...
                  child: Text(isEn ? 'Teacher' : 'Enseignant(e)', style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold))),
            ]),
          ),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Icon(Icons.people_outline_rounded, color: _accent, size: 22),
                const SizedBox(width: 10),
                Text(isEn ? 'Class Results' : 'Résultats de la Classe',
              ...
              Center(child: Column(children: [
                ...
                Text(isEn ? 'Results will appear once students complete their assessments.'
                           : 'Les résultats apparaîtront lorsque les élèves auront terminé leurs évaluations.',
                    style: TextStyle(color: _sub, fontSize: 13), textAlign: TextAlign.center),
              ])),
            ]),
          ),
        ]),
