...
class AdminDashboard extends StatelessWidget {
  ...
  final bool isEn;
  const AdminDashboard({super.key, required this.user, required this.isDarkMode, required this.isEn});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(isEn ? 'MINESEC Administrator' : 'Administrateur MINESEC', style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.public_rounded, color: _accent, size: 22),
                      const SizedBox(width: 10),
                      Text(isEn ? 'National System Analytics' : 'Statistiques Nationales', style: TextStyle(color: _text, fontWeight: FontWeight.w800, fontSize: 16)),
                    ],
                  ),
                  ...
                  Center(
                    child: Column(
                      children: [
                        Icon(Icons.insights_rounded, color: _sub, size: 40),
                        const SizedBox(height: 10),
                        Text(
                          isEn ? 'National VARK statistics across all 10 regions will display here.' : 'Les statistiques nationales VARK des 10 régions s\'afficheront ici.',
